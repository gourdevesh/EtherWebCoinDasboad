...
import UpdateTnxPassword from './components/UpdateTnxPassword'
import FundTransfer from './components/FundTransfer'
import WithDraw from './components/Withdraw'
import DepositHistoryTable from './components/DepositHistory'
import LevelIncomeTable from './components/LevelIncomeTable'
import ReferralIncomeTable from './components/ReferralIncomeTable'
import TeamBusinessTable from './components/TeamBusinessTable'

const Dashboard = React.lazy(() => import('./views/dashboard/Dashboard'))
const MyRank = React.lazy(() => import('./components/MyRank'))
const Profile = React.lazy(() => import('./components/Profile'))
const WalletOverview = React.lazy(() => import('./components/WalletOverView'))
...
const routes = [
  ...
  { path: '/my-rank', name: 'My Rank', element: MyRank },
  { path: '/wallet', name: 'Wallet', element: WalletOverview },
  { path: '/my-team', name: 'My Team', element: MyTeam },
  { path: '/stake', name: 'Stack', element: Stake },
